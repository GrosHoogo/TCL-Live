...
import { Search, X, AlertTriangle, Info, CheckCircle, Radio } from 'lucide-react'
      ...
      <div className="flex-shrink-0 px-4 pt-3 pb-2 bg-gray-50 sticky top-0 z-10">
        <div className="relative">
          ...
          <input
            ...
            placeholder="Filtrer par ligne ou titre (ex: T1, C3)…"
      ...
      {filtered.length > 0 && (
        <div className="flex-1 overflow-y-auto px-4 pb-4 space-y-3">
          ...
          <p className="text-xs text-gray-400 pt-1">
            {filtered.length} perturbation{filtered.length > 1 ? 's' : ''} en cours
          </p>
          {filtered.map((alert) => (
